        ...
        <Table>
          ...
          <Table.Body class="divide-y">
            <Table.Row class="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell class="truncate">Dashboard page hit</Table.Cell>
            ...
            <Table.Row class="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell>98767</Table.Cell>
              <Table.Cell class="truncate">Settings page hit</Table.Cell>
            ...
            <Table.Row class="bg-white dark:border-gray-700 dark:bg-gray-800">
              ...
              <Table.Cell class="truncate">New article took .0038s</Table.Cell>
